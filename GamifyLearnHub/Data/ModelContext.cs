...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseOracle("User Id=ApiProject;PASSWORD=12345;DATA SOURCE=localhost:1521/XEPDB1");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.HasDefaultSchema("APIPROJECT")
            ...
            modelBuilder.Entity<Assignmentsolution>(entity =>
            {
                ...
                entity.HasOne(d => d.Assignment)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009268");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Assignmentsolutions)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009269");
            });
            ...
            modelBuilder.Entity<Assignmentsolutiondetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Assignment)
                    ...
                    .HasForeignKey(d => d.Assignmentid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009274");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Assignmentsolutiondetails)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009273");
            });
            ...
            modelBuilder.Entity<Attendencedetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Attendence)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009313");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Attendencedetails)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009312");
            });
            ...
            modelBuilder.Entity<Cartitem>(entity =>
            {
                ...
                entity.HasOne(d => d.Cart)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009306");

                entity.HasOne(d => d.Program)
                    .WithMany(p => p.Cartitems)
                    .HasForeignKey(d => d.Programid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009344");

                entity.HasOne(d => d.Section)
                    .WithMany(p => p.Cartitems)
                    .HasForeignKey(d => d.Sectionid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009366");
            });
            ...
            modelBuilder.Entity<Certification>(entity =>
            {
                ...
                entity.HasOne(d => d.Coursesequence)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009343");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Certifications)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009295");
            });
            ...
            modelBuilder.Entity<Examsolution>(entity =>
            {
                ...
                entity.HasOne(d => d.Questionoption)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009256");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Examsolutions)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009255");
            });
            ...
            modelBuilder.Entity<Examsolutiondetail>(entity =>
            {
                ...
                entity.HasOne(d => d.Exam)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009260");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Examsolutiondetails)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009261");
            });
            ...
            modelBuilder.Entity<Program>(entity =>
            {
                ...
                entity.HasOne(d => d.Educationalperiod)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009349");

                entity.HasOne(d => d.Plan)
                    .WithMany(p => p.Programs)
                    .HasForeignKey(d => d.Planid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009200");
            });
            ...
            modelBuilder.Entity<Section>(entity =>
            {
                ...
                entity.HasOne(d => d.Coursesequence)
                    ...
                    .HasForeignKey(d => d.Coursesequenceid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009342");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Sections)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009228");
            });
            ...
            modelBuilder.Entity<Usercoupon>(entity =>
            {
                ...
                entity.HasOne(d => d.Coupon)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009326");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Usercoupons)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009325");
            });
            ...
            modelBuilder.Entity<Userlogin>(entity =>
            {
                ...
                entity.HasIndex(e => e.Username, "SYS_C009191")
                    .IsUnique();
                ...
                entity.HasOne(d => d.Role)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009193");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Userlogins)
                    .HasForeignKey(d => d.Userid)
                    .HasConstraintName("SYS_C009192");
            });
            ...
            modelBuilder.Entity<Userpointsactivity>(entity =>
            {
                ...
                entity.HasOne(d => d.Pointsactivity)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009282");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Userpointsactivities)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009281");

                entity.HasOne(d => d.Usersection)
                    .WithMany(p => p.Userpointsactivities)
                    .HasForeignKey(d => d.Usersectionid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009283");
            });
            ...
            modelBuilder.Entity<Userprogress>(entity =>
            {
                ...
                entity.HasOne(d => d.Lecture)
                    ...
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009317");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Userprogresses)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009316");
            });
            ...
            modelBuilder.Entity<Usersection>(entity =>
            {
                ...
                entity.HasOne(d => d.Section)
                    ...
                    .HasForeignKey(d => d.Sectionid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009233");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Usersections)
                    .HasForeignKey(d => d.Userid)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("SYS_C009232");
            });
